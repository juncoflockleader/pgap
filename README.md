...
| **`sound`** | [pgap-sound/](pgap-sound/) | SFX / UI / creature vocals / impacts / ambient loops (WAV) — *not music, not voice* | **Implemented** (MVP S0–S5 + impacts + ambient + seeded variance) |
